    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <div class="flex justify-center flex-col">
            <button 
                ...
                class="mt-1 mb-1 flex justify-center items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium font-semibold text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
            ...
            <button 
                ...
                class="mt-1 mb-1 py-2 px-4 max-w-md flex justify-center items-center bg-gray-600 hover:bg-gray-700 focus:ring-gray-500 focus:ring-offset-gray-200  text-sm text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="h-6 w-6 mr-2" viewBox="0 0 1792 1792">
...
const loginWithGithub = async() => {
    const { ok } = await authStore.createUserGithub()
